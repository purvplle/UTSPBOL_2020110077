...
public class DBCust {
    ...
    public ObservableList<CustModel>  Load() {
        try {
            ...
            ResultSet rs = con.statement.executeQuery("Select idmember, namabarang, alamat, total from customer");
int i = 1;
            while (rs.next()) {
                CustModel d=new CustModel();
                d.setIdmember(rs.getString("idmember"));                
                d.setNamabarang(rs.getString("namabarnag"));
 ...
 public int validasi(String nomor) {
  ...
  public boolean insert() {
        ...
        try {       
            ...
            con.preparedStatement.setString(2, getCustModel().getNamabarang());
...
public boolean update() {
        ...
        try {            
            ...
            con.preparedStatement.setString(1, getCustModel().getNamabarang());
